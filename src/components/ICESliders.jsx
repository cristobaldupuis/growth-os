      ...
      {dims.map(d=>(
        <div key={d.key}>
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
            <span style={{fontSize:12,color:t.textSub,fontFamily:t.sans}}>{d.label}</span>
          ...
          <div style={{fontSize:11,color:t.textMuted,fontFamily:t.sans,marginTop:2}}>{d.hint}</div>
        </div>
      ))}
      <div style={{display:"flex",alignItems:"center",gap:8,paddingTop:4,borderTop:"1px solid "+t.border}}>
        <span style={{fontSize:12,color:t.textMuted,fontFamily:t.sans}}>ICE Score:</span>
